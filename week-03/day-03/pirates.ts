...
class Pirate {
  intoxicatedValue: number = 0;
  healtValue: number = 100;
  ...
  drinkSomeRum() {
    if (this.healtValue - this.intoxicatedValue > 0) {
      this.intoxicatedValue += 5;
      this.healtValue -= this.intoxicatedValue;
    } else {
      this.isAlive = false;
      this.healtValue = 0;
    }
  ...
  howsItGoingMate() {
    if (this.intoxicatedValue < this.intoxicatedValue * 5) {
  ...
  brawl(x: Pirate) {
    let results: any[] = [
      [x.die()],
      [this.healtValue = 0],
      [x.isPassedOut = true, this.isPassedOut = true]
    ];
    if (x.healtValue > 0) {
